...
import pieChart from '../media/pieChart.webp'
                ...
                <section className="HeroSection_top">
                    <div className="HeroSection_top_inner_div">
                        <div className="HeroSection_top_text animate__fadeIn animate__animated">
                            <div className="HeroSection_top_nomo_text">
                                <div className='HerSection_top_nomo_text_half'>
                                    N
                                </div>
                                <div>
                                    <img src={logo} alt="o" className='HerSection_top_nomo_img_half' />
                                </div>
                                <div className='HerSection_top_nomo_text_half'>
                                    MO
                                </div>
                    ...
                    <div className="HeroSection_Page6_step_imgs">
                        <div className="HeroSection_Page6_step_imgs_inner">
                            {steps.map((step, index) => {
                                return <div className={`step_imgDiv step_imgDiv${index + 1}`} ><img src={step} alt="" className={`step${index + 1}_img all_step_img `} key={index} /></div>
                            })}
                        </div>
                    </div>
                </section>
